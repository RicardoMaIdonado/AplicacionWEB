...
<body>
    ...
    <div class="container justify-content-center">
        ...
        $lista = array();
        $lista = (new ManejoNoticias())->ListarNoticias();
        foreach ($lista as $rtu) {
        ?>
            <form action="noticias/formUpdateNoticia.php" method="POST">
                <div class="input-group">
                    <input class="form-control" style="max-width: 58px;" name="idnoticia" readonly type="text" value=<?php echo $rtu[0] ?>>
                    <input class="form-control" name="titulonoticia" readonly type="text" value="<?php echo $rtu[1] ?>">
